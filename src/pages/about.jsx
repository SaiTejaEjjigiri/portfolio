  ...
  return (
    <div className="about-container">
      <div className="about-intro">
        ...
        Greetings! I am a dedicated software engineer currently contributing my skills and expertise at Albertsons, a leading name in the tech industry. With a career journey spanning several esteemed organizations including AT&T, and Cisco Systems, where I embarked on a transformative internship in 2016, I have continually immersed myself in the dynamic realm of technology. 
         </p>
         <p className="about-details">
